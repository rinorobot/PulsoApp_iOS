...
import UIKit
import WebKit
class Cuestionario: UIViewController, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        let myWebView:WKWebView = WKWebView(frame: CGRect(x:0, y:0, width: UIScreen.main.bounds.width, height:UIScreen.main.bounds.height))
              ...
              let myURL = URL(string: "https://catedraunescodh.unam.mx/catedra/violencia/cuestionario-violencia-en-el-noviazgo.html")
